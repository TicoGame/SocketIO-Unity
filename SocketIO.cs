...
using SocketIO.Unity.Exceptions;
using SocketIO.Unity.Extensions;
using SocketIO.Unity.JsonSerializer;
using SocketIO.Unity.Messages;
using SocketIO.Unity.Transport;
using SocketIO.Unity.Transport.Http;
using SocketIO.Unity.Transport.WebSockets;
using SocketIO.Unity.UriConverters;

namespace SocketIO.Unity
{
    /// <summary>
